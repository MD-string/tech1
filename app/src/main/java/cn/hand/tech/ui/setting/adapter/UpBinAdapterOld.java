...
public class UpBinAdapterOld extends BaseExpandableListAdapter {
    ...
    public UpBinAdapterOld(Context mContext, List<BGuJianBean> mList, Callback callback) {
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.lvitem_bin_item_1, null);
