 ...
 */
public class RepairNormalAdapter extends BaseAdapter {
    private final onNormalListener mOnClickListener;
    ...
    public RepairNormalAdapter(Context context, List<A1> list, int nub, String first) {
        this.context = context;
        this.mlist = list;
        this.mnub=nub;
        this.mFirst=first;
        inflater = LayoutInflater.from(this.context);
        mOnClickListener = (onNormalListener) context;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView =inflater.inflate(R.layout.adapter_repair_item_1, null);
