...
public class PassSettingActNew extends BaseActivity {
    ...
    public static void start(Context context,String tag) {
        Intent intent = new Intent(context, PassSettingActNew.class);
        intent.putExtra("start_tag",tag);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        context=this;
        setContentView(R.layout.activity_pass_choose_new);
    ...
    private void init() {
        PassSettingFragment bsFragment=new PassSettingFragment();
        Bundle bundle=new Bundle();
        bundle.putString("pass_tag",mtag);
        bsFragment.setArguments(bundle);

        PassSettingValueFragment cpFragment=new PassSettingValueFragment();
