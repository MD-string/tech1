...
import cn.hand.tech.ui.setting.presenter.EnterFrgCheckPresenter;
 ...
 *自动检测  进厂检测
 */
public class EnterFrgoryCheckFragment extends BaseFragment implements  IAutoCheckView{
    ...
    private EnterFrgCheckPresenter mpresenter;
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, EnterFrgoryCheckFragment.class);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        context=getActivity();
        View view = inflater.inflate(R.layout.activity_auto_check_2, container, false);
        mpresenter = new EnterFrgCheckPresenter(context, this);
